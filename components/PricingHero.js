      ...
      <section className="pt-[60px] pb-[60px] md:pt-[100px] md:pb-[100px] relative bg-[url('../images/price-hero-bg.png')] bg-cover">
        <div className="innerDiv">
          <div className="text-center" data-aos="fade-up">
            <h1 className="font-[800] lg:text-[72px] md:text-[60px] text-[40px] md:leading-[1] text-[#2B2866] tracking-[-0.02em]">
              ...
              <div className="relative">
               ...
               <Range
                  ...
                  renderTrack={({ props, children }) => (
                    ...
                    >
                      {children}
                      <div className="absolute left-0 selected-area" style={{width:((values/25000) * 100).toFixed(2) + "%"}}></div>
                ...
                <div className="lg:px-3 sm:px-2 lg:w-1/4 md:w-1/2 sm:w-1/2 w-full">
                  ...
                  >
                    ...
                    <div className="mt-6 flex items-center gap-[8px] justify-center">
                      ...
                      <span className="text-[16px] text-[#0C111D] font-[500] tracking-[-0.017em] leading-[24px]">
