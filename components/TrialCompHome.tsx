...
import LiveChatImg from "../images/Live-Chat-img2.svg";
import LiveChatIMobilemg from "../images/Live-Chat-mobile-img2.png";
import ThemeButton from "../ui/button";
const TrialCompHome: NextComponentType = () => {
  return (
    <>
      <section className="">
              ...
              <div className="lg:w-[calc(50%+10px)] xl:w-[44%] w-full lg:px-0 px-6 xl:pt-[38px]">
                <div className="md:text-left text-center" data-aos="fade-right">
                  ...
                  <div className="flex lg:flex-row flex-col gap-5">
                    ...
                    <Link
                      href={"#"}
                      className="inline-block text-center py-[10px] px-[14px] rounded-[10px] text-[#475467] text-[14px] font-[400] leading-[20px] tracking-[-0.006em] [box-shadow:0px_0px_0px_1px_#E1E4EA,_0px_1px_3px_0px_#0E121B1F] bg-white"
                    >
                      Book a Demo
                    </Link>
                  </div>
