  ...
  return (
    <>
      <section className="md:mb-16 pt-12 md:pt-20 relative sm:bg-[url('../images/social-hero-bg.png')] bg-[url('../images/social-hero-mobile-bg.png')] bg-cover bg-no-repeat bg-bottom">
        <div className="innerDiv lg:w-[896px] lg:px-0">
          <div className="text-center" data-aos="fade-up">
            ...
            <h1 className="font-[600] inter-display lg:text-[72px] md:text-[60px] text-[40px] leading-[1] text-[#2B2866] tracking-[-0.02em]">
            ...
            <p className="text-[#475467] md:text-base text-sm tracking-[-0.011em] font-[400] mt-5 mb-8 mx-auto">
