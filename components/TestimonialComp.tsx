...
const TestimonialComp: NextComponentType = () => {
  return (
    <>
      <section className='lg:pt-24 lg:pb-16 md:py-20 sm:py-16 py-12 bg-[url("../images/bg-testimonial.png")] bg-cover bg-top'>
        <div className="innerDiv">
          <div className="text-center mb-16" data-aos="fade-up">
            ...
            <p className="text-[16px] font-[400] leading-[24px] tracking-[-0.011em] mt-6 text-[#475467]">
