...
const ThemeButton = ({ children, className="" }: { children: ReactNode, className?: string }) => {
  return (
    <button className={twMerge(`w-full flex items-center gap-2 text-center justify-center relative bg-[#6962fb] py-[10px] pl-[14px] pr-[10px] rounded-[10px] text-white overflow-hidden shadow-[0px_0px_0px_1px_#335cff,0px_1px_2px_0px_rgba(14,18,27,0.24)] text-[14px] font-[400] leading-[20px] tracking-[-0.006em]`, className)}>
      {children}
